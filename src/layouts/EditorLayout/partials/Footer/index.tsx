            ...
            <div className="h-full flex flex-col sm:flex-row lg:flex-col justify-between">
              <div className="mb-4 sm:mb-0">
                ...
                <div className="text-sm text-slate-300">
                  © Hormas.com <span className="text-slate-500">-</span>
                  All rights reserved.
                </div>
              </div>
              {/* Social links */}
              <ul className="flex">
                <li>
                  <a
                    className="flex justify-center items-center text-primary-500 hover:text-primary-400 transition duration-150 ease-in-out"
                    href="#0"
                    aria-label="Twitter">
                    <svg
